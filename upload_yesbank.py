"""Upload yesbank_short.mp4 to YouTube."""
...
VIDEO_PATH   = r"C:\Users\user\Desktop\YTShorts\output\yesbank_short.mp4"
TITLE        = "Yes Bank Turnaround! Rs.952Cr Profit + GNPA 1.5% + CET1 13.9% - Buy Time?"

SUMMARY = (
    "Yes Bank ka turnaround narrative phir spotlight mein! "
    "Q3 FY26 mein Rs.952Cr profit, GNPA 1.5%, NNPA 0.3%, Provision Coverage 83%+. "
    "CET1 13.9% - capital position strong hai. "
    "Analysts cautious - short term target Rs.20-24 range. High risk high reward play."
)

TAGS = [
    "YesBank", "Turnaround", "Q3Results", "BankingStocks", "NPAs",
    "ProfitGrowth", "HighRiskHighReward", "IndianStocks", "ShareMarketIndia",
    "YesBankStock", "PrivateBanks", "StockMarket", "NSE", "MarketToday",
    "StockAlert", "BankNifty", "BreakingStockNews", "StockAnalysis",
...
def main():
    ...
    desc  = (f"{TITLE}\n\n{SUMMARY}\n\n"
             ...
             f"🔔 Bell icon dabao!\n\n"
             f"{'━'*32}\n{htags}\n{'━'*32}\n"
             f"#Shorts #YouTubeShorts #StockMarket #IndianStocks #BankNifty")
